...
function BreweryCard({ name, logo, website, address, phone }) {
  return (
    <>
      <Col sm={12} md={12} lg={6} className="gap-3 mb-5 mt-5">
        <Card className="card-div mx-auto">
          <Card.Img className="img-fluid" src={"holder.js/100px270"} alt="Card image" />
          <Card.ImgOverlay>
            ...
            <div className="card-footer-div bg-light text-muted d-flex align-items-center gap-1">
